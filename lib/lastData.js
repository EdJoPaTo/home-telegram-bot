...
function setSensorValue(position, type, newValue) {
  if (!last[position]) {
    last[position] = {}
  }

  last[position][type] = newValue
}
...
module.exports = {
  ...
  getAllSensorValues: getAllSensorValues,
  setSensorValue: setSensorValue,
  getPositions: getPositions,
  getAllTypesOfPosition: getAllTypesOfPosition
}
